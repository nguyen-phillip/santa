...
+ (SNTStoredEvent *)recentlyBlockedEventWithSHA256:(NSString *)sha256 {
  LOGI(@"#### SNTExecutionController -- recentlyBlockedEventWithSHA256:%@", sha256);
  ...
  if (se) LOGI(@"#### SNTExecutionController -- %@", se);
  else LOGI(@"#### SNTExecutionController -- couldn't find sha256 in cache");
